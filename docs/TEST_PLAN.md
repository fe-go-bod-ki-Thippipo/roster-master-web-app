...
**Gate:** 002a-1 implementation PR must execute EMP-01..EMP-12, INT-01/02, AUD-01/02, MIG-02/03 and X12–X14/X18 on disposable PostgreSQL and attach results. APR-13 midnight cancellation/activation race remains 002a-2; this documentation adds no SQL or executed tests.
...
| EMP-13 | cancelled employee and active employee with T | insert/update assignment outside [H,T] or for cancelled employee; cancel employee with effective assignment | all rejected unless approved correction removes effective assignment before cancellation |
